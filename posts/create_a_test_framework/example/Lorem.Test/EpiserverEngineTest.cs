...
namespace Lorem.Test
{
    public class EpiserverEngineTest
    {
        ...
        [InlineData(2)]
        [InlineData(3)]
        public void StartWithEpiserverEngineFirstIteration_RunMultipleTimesNoUser_SinglePageExists(int _)
        {
            var engine = new EpiserverEngineFirstIteration();
            engine.Start();
        ...
        [InlineData(2)]
        [InlineData(3)]
        public void StartWithEpiserverEngineThirdIteration_RunMultipleTimesNoUser_SinglePageExists(int _)
        {
